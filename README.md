# 🧠 Web Development Learning Journal: A Daily Progress Log
...
| **Day 2** | 10/10/2025 | Advanced HTML Elements and Forms |
| **Day 3** | 13/10/2025 | Introduction to CSS & Styling Basics |
| **Day 4** | 30/10/2025 | CSS Flexbox, Grid & Visual Enhancements |
| **Day 5** | 31/10/2025 | CSS Pseudo-classes, Animations & Transitions |
| **Day 6** | 03/11/2025 | Responsive CSS & Media Queries |
| **Day 7** | 05/11/2025 | Introduction to Bootstrap |
| **Day 8** | 06/11/2025 | Bootstrap Components & Responsive Design Revision |
| **Day 9** | 10/11/2025 | Introduction to JavaScript, Types, Operators & Control Structures |
| **Day 10** | 12/11/2025 | JavaScript Scope, Events, Strings & Arrays |
| **Day 11** | 13/11/2025 | JavaScript ES Features, DOM & Practical Applications |
| **Day 12** | 17/11/2025 | JavaScript ES Classes, Objects & Responsive Sidebar |

---

## 📅 Day 1 — Introduction to Web Development

> **Date:** _09/10/2025_ | **Topic:** Introduction to Web Development & HTML Basics
...
* 🔍 **Key Terms:** Localhost, Ports, and Rendering pages via IP address
...
> **Date:** _10/10/2025_ | **Topic:** Advanced HTML Elements and Forms
...
> **Date:** _13/10/2025_ | **Topic:** Introduction to CSS & Styling Basics
...
> **Date:** _30/10/2025_ | **Topic:** CSS Flexbox, Grid & Visual Enhancements
...
> **Date:** _31/10/2025_ | **Topic:** CSS Pseudo-classes, Tooltips, Animations, Transitions, Transform Properties & Box Sizing
...
> **Date:** _03/11/2025_ | **Topic:** Responsive CSS — Filters, Responsive Web Design Principles & CSS Media Queries
...
> **Date:** _05/11/2025_ | **Topic:** Introduction to Bootstrap, Bootstrap Basics, Grids & Bootstrap CSS
...
> **Date:** _06/11/2025_ | **Topic:** CSS Revision & Advanced Bootstrap Components (Carousel, Progress Bar, etc.)
...
> **Date:** _10/11/2025_ | **Topic:** Introduction to JavaScript, Types, Operators, Logical Operators, Math, and Control Structures
...
> 2.  Checks if the first number is greater than the second using logical and comparison operators
> 3.  Displays results dynamically using `alert()` or `console.log()`
...
> **Date:** _12/11/2025_ | **Topic:** JavaScript Scope, Events, Strings & Arrays
...
>
> 1.  Different **types of variable scopes** in JavaScript
> 2.  Handling **button click events** to trigger changes dynamically
> 3.  Performing **string manipulations** (uppercase, lowercase, slicing)
> 4.  Creating and updating **arrays** with various operations
...
> **Date:** _13/11/2025_ | **Topic:** JavaScript ES Features — DOM, Hoisting, Functions & Arrow Functions

### 🧩 Concepts Covered

* 🌐 **DOM (Document Object Model):** Understood how to access and manipulate HTML elements dynamically using `getElementById`, `querySelector`, and property updates.
* 🚀 **Hoisting:** Learned how JavaScript moves **variable and function declarations** to the top of their scope, affecting how code executes.
* ⚙️ **Functions & Arrow Functions:** Explored regular functions, arrow function syntax, differences, and benefits (cleaner, modern approach).
...
>
> 1.  **Counter App** using DOM methods and event listeners
> 2.  **Image Resize App** using width/height manipulation
>
...
> **Date:** _17/11/2025_ | **Topic:** JavaScript ES Classes, Objects, Hoisting Recap & Responsive Hamburger Menu

### 🧩 Concepts Covered

* 🏗️ **JavaScript ES Classes:** Understood how to define classes, create objects, and use constructors & methods.
* 📦 **Objects in JavaScript:** Explored object creation, accessing properties, modifying values, and using methods inside objects.
* 🔁 **Quick Recap — Hoisting & Functions:** Revised how hoisting works with variables and functions to avoid common errors.
* 🍔 **Hamburger Menu using Media Queries:** Practiced building a **responsive hamburger icon** and a **responsive sidebar menu** that appears on smaller screens.
